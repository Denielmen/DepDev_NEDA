        ...
        <div class="main-content">
            ...
            @if($trainings->count())
                <div class="d-flex justify-content-end mt-3 mb-3 gap-2">
                    <a href="{{ route('user.training.completed.export', $trainings->first()->id) }}" class="btn btn-info">
                        <i class="bi bi-download me-2"></i>Export PDF
                    </a>
                    <a href="{{ route('user.training.completed.export-excel', $trainings->first()->id) }}" class="btn btn-success">
